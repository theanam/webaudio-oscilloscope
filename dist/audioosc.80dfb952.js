...
var Analyzer = /*#__PURE__*/function () {
  function Analyzer(ctx, source) {
    ...
    _classPrivateFieldSet(this, _anl, ctx.createAnalyser());

    source.connect(_classPrivateFieldGet(thos, _anl));
    if (dest) _classPrivateFieldGet(this, _anl).connect(dest);
  }
...
//# sourceMappingURL=/audioosc.80dfb952.js.map